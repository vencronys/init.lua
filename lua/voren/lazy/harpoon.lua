return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>a", function() harpoon_mark.add_file() end, { desc = "Add file to Harpoon" })
        vim.keymap.set("n", "<C-e>", function() harpoon_ui.toggle_quick_menu() end, { desc = "Toggle Harpoon menu" })
        ...
        vim.keymap.set("n", "<leader><C-h>", function() replace_mark_at(1) end, { desc = "Replace Harpoon mark 1" })
        vim.keymap.set("n", "<leader><C-t>", function() replace_mark_at(2) end, { desc = "Replace Harpoon mark 2" })
        vim.keymap.set("n", "<leader><C-n>", function() replace_mark_at(3) end, { desc = "Replace Harpoon mark 3" })
        vim.keymap.set("n", "<leader><C-s>", function() replace_mark_at(4) end, { desc = "Replace Harpoon mark 4" })
    end,
}
